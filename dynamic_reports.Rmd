...
Of course one may want to replace the current text with something more useful, modify the code, possibly add some graphs, etc. The key thing here is that in the final output the R-code that is not presented.
