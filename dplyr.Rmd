...
```{r}
sau <-
  read.csv("/run/media/einarhj/stasi/prj2/crfm2017/crfmr/data-other/seaaroundus/SAU_FAO_31_v44-1.csv",
           stringsAsFactors = FALSE)
#sau <- 
  #read_csv("/run/media/einarhj/stasi/prj2/crfm2017/crfmr/data-other/seaaroundus/SAU_FAO_31_v44-1.csv")
...
download.file('http://www.hafro.is/~einarhj/education/ofcouRse2016/data/ellidaar.xlsx',
              'data-raw/ellidaar.xlsx')
```


```{r}
ellidaar <- 
  read_excel('data-raw/ellidaar.xlsx')
```
...
* quickly calculate summary statistics by country
...
```{r}
sau.slice <- 
  slice(sau, c(1,4:6,100)) ## 1st, 4th, 5th, 6th and the 100th row
glimpse(sau.slice)
```
